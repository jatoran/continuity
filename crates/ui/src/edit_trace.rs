...
pub(crate) fn kind_of(edit: &SelectionEdit) -> &'static str {
    use SelectionEdit::{
        ...
        MarkdownCycleHeading, MarkdownCycleListMarker, MarkdownDemoteSection,
        ...
        MarkdownToggleEmphasis, MarkdownToggleNumbered, MarkdownWrapInBlockquote, MoveLineDown,
        MoveLineUp, Outdent, ReflowParagraph, ReverseLines, ShuffleLines, SortLines, SpacesToTabs,
        SurroundSelection, TabsToSpaces, TabsToSpacesAll, ToggleBulletAtLineStart, TransposeChars,
        TransposeWords, TrimTrailingWhitespace, TrimTrailingWhitespaceAll, UniqueLines,
        WrapAtColumn,
    };
    match edit {
