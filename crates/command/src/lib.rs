...
pub use view::{
    register_view_commands, VIEW_SCROLL_DOC_END, VIEW_SCROLL_DOC_START, VIEW_SCROLL_LINE_DOWN,
    VIEW_SCROLL_LINE_UP, VIEW_SCROLL_PAGE_DOWN, VIEW_SCROLL_PAGE_UP, VIEW_SET_FONT_FAMILY,
    VIEW_SET_FONT_SIZE, VIEW_TOGGLE_ALL_LINE_NUMBERS, VIEW_TOGGLE_FILE_TREE,
