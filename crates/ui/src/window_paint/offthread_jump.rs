...
//!
//! Thread ownership: mutates `EditorSurface::jump_offthread_polls` on the UI
...
/// or far reveal jump arms `EditorSurface::jump_offthread_polls` to this many
...
impl Window {
    ...
    /// after `self.surface.view` has moved to the target so prewarm targets the
    ...
    pub(crate) fn arm_offthread_jump(&mut self, reason: &'static str) {
        ...
        self.surface.jump_offthread_polls = JUMP_OFFTHREAD_MAX_POLLS;
    }
}
